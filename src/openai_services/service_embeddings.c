...
embeddings_init_service_options(void *service)
{
	...
	strcpy(ai_service->service_data->model, MODEL_OPENAI_EMBEDDINGS);
	strcpy(ai_service->service_data->name_description, SERVICE_OPENAI_DESCRIPTION);
	strcpy(ai_service->service_data->model_description, MODEL_OPENAI_EMBEDDINGS_DESCRIPTION);
...
embeddings_set_and_validate_options(void *service, void *function_options)
{
	...
	set_option_value(ai_service->service_data->options, OPTION_MODEL_NAME, MODEL_OPENAI_EMBEDDINGS);
